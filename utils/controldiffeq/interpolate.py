...
class NaturalCubicSpline:
    ...
    def derivative(self, t):
        ...
        fractional_part, index = self._interpret_t(t) #得到小数部分和index
        inner = self._two_c[..., index, :] + self._three_d[..., index, :] * fractional_part #得到二次项系数
        deriv = self._b[..., index, :] + inner * fractional_part #得到导数
        return deriv
